...
class DrawDialog(wx.Frame):
    ...
    def __init__(self, *args, **kwargs):
        ...
        MainSizer.Add(polybutton, 0, wx.CENTER | wx.EXPAND | wx.ALL, 1)    # Add(item, proportion, flags, border)
        MainSizer.Add(self.navpanel, 4, wx.EXPAND)
...
app = wx.App(False)
dlg = DrawDialog(None, title="FloatCanvas Dialog Demo", size=(700, 700))
dlg.Show()
app.MainLoop()