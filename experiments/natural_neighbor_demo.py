...
See https://raw.githubusercontent.com/innolitics/natural-neighbor-interpolation/master/demo/demo.py
'''
import numpy as np
...
def compare_interp_for_func(func, func_as_string, image_name):
    ...
    # We've interpolated over a 3D volume.
    # Visualize just the slice z=20.
